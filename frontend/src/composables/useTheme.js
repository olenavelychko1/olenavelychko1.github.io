...
export function useTheme() {
  ...
  // initialize theme: prefer saved -> prefers-color-scheme -> dark
  onMounted(() => {
  ...
  function iconHtml() {
    return current.value === 'dark' ? icons.sun : icons.moon;
  }

  return { current, setTheme, toggle, iconHtml };
}
